...
def add_global_flags(
  ...
  *,
  ...
  parser.add_argument(
    '--experiment', default=_default(s, None), metavar='SLUG', help='experiment slug'
  )
  parser.add_argument('--dataset', default=_default(s, None), metavar='NAME', help='dataset name')
  parser.add_argument(
    '--split',
    default=_default(s, None),
    metavar='NAME',
