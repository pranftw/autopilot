...
from autopilot.ai.models import JC, JI, JR, JudgeConfig, JudgeInput, JudgeResult
...
class JudgeProtocol(Protocol[JC, JI, JR]):
...
class Judge(Generic[JC, JI, JR]):
  """Base for evaluation judging using step-based workflows.

  Same Step abstraction as DataGenerator. LLM steps produce structured
