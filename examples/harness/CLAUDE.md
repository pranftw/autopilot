# harness -- Agent Operations Guide

You are an external coding agent working on the **harness** project, powered by the
...
autopilot execute -c 'from harness.module import ...; result = m.forward(batch); print(result)'

# check what parameters exist
autopilot execute -c 'from harness.module import ...; print(list(m.parameters()))'
```
