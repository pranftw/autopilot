# multi_module -- Agent Operations Guide

You are an external coding agent working on the **multi_module** project, powered by the
...
autopilot execute -c 'from multi_module.module import ...; result = m.forward(batch); print(result)'

# check what parameters exist
autopilot execute -c 'from multi_module.module import ...; print(list(m.parameters()))'
```
