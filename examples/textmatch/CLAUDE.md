# textmatch -- Agent Operations Guide

You are an external coding agent working on the **textmatch** project, powered by the
...
autopilot execute -c 'from textmatch.module import ...; result = m.forward(batch); print(result)'

# check what parameters exist
autopilot execute -c 'from textmatch.module import ...; print(list(m.parameters()))'
```
